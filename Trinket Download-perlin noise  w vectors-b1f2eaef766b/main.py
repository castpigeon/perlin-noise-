...
#picking the vectors from this list with a seed or randomly supposedly makes the noise better, have not tested yet

class Perlin_stuff:
  chunk_vectors = [] #hold the vectors of every created chunk, must figure out how to handle expansion in all directions ie: infinite worlds, (negative indexing?)
  perlin_map = []
